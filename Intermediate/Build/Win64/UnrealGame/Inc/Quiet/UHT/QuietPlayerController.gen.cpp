...
struct Z_CompiledInDeferFile_FID_Quiet_Source_Quiet_PlayerController_QuietPlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AQuietPlayerController, AQuietPlayerController::StaticClass, TEXT("AQuietPlayerController"), &Z_Registration_Info_UClass_AQuietPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AQuietPlayerController), 177470257U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Quiet_Source_Quiet_PlayerController_QuietPlayerController_h_3986540805(TEXT("/Script/Quiet"),
